...
import org.archanasweets.online.Domain.Category;
import org.archanasweets.online.Domain.HomeMetaData;
import org.archanasweets.online.Domain.Menu;
import org.archanasweets.online.Domain.Pricing;
...
public class MainController {
    ...
    public String getSweets(Model model, RestTemplate restTemplate) throws JsonProcessingException {
        ...
        try {
            URL url = new URL("http://localhost:8081/sweetpeople/category/sweets");
    ...
    public String getSavouries(Model model, RestTemplate restTemplate) throws JsonProcessingException {
        ...
        List<Category> categoryList = null;
        try {
            URL url = new URL("http://localhost:8081/sweetpeople/category/savouries");
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("GET");
            httpURLConnection.setRequestProperty("Accept", "application/json");
            if (httpURLConnection.getResponseCode() != 200) {
    ...
    public String getAboutPage(@RequestParam("menuItemSubCategory") String menuItemSubCategory,  Model model, RestTemplate restTemplate){
        ...
        try {
            ...
            URL url = new URL("http://localhost:8081/sweetpeople/items/" + menuItemSubCategory);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("GET");
            httpURLConnection.setRequestProperty("Accept", "application/json");
        ...
        for(Menu menu: menuList){
            ...
            try {
                URL url = new URL("http://localhost:8081/sweetpeople/pricing/" + menu.getMenuItemId());
                HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                httpURLConnection.setRequestMethod("GET");
                httpURLConnection.setRequestProperty("Accept", "application/json");
